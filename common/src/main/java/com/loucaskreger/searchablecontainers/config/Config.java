...
import com.loucaskreger.searchablecontainers.ConfigPathExpectPlatform;
...
public class Config {
    ...
    private static final File configFolder = ConfigPathExpectPlatform.getConfigDirectory().toFile();
